        ...
        public async Task<ResponseModel> ExportTicket_TRC_Report(ManageReport_Search parameters)
        {
            ...
            using (MemoryStream msExportDataFile = new MemoryStream())
            {
                using (ExcelPackage excelExportData = new ExcelPackage())
                {
                    ...
                    WorkSheet1.Cells[1, 20].Value = "Product Serial No.";
                    ...
                    foreach (var items in lstSizeObj)
                    {
                        ...
                        WorkSheet1.Cells[recordIndex, 20].Value = items.ProductSerialNumber;
                        WorkSheet1.Cells[recordIndex, 21].Style.Numberformat.Format = DateTimeFormatInfo.CurrentInfo.ShortDatePattern;
                        WorkSheet1.Cells[recordIndex, 21].Value = items.DateofManufacturing;
