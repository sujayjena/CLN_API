...
namespace CLN.Persistence.Repositories
{
    public class ManageReportRepository : GenericRepository, IManageReportRepository
    {
        ...
        public async Task<IEnumerable<InMaterialConsumptionReport_Response>> GetInMaterialConsumptionReport(ManageReport_Search parameters)
        {
            DynamicParameters queryParameters = new DynamicParameters();
            ...
            var result = await ListByStoredProcedure<InMaterialConsumptionReport_Response>("GetInMaterialConsumptionReport", queryParameters);
            parameters.Total = queryParameters.Get<int>("Total");

            return result;
        }

        public async Task<IEnumerable<OutMaterialConsumptionReport_Response>> GetOutMaterialConsumptionReport(OutMaterialConsumptioneReport_Search parameters)
        {
            DynamicParameters queryParameters = new DynamicParameters();
            ...
            var result = await ListByStoredProcedure<OutMaterialConsumptionReport_Response>("GetOutMaterialConsumptionReport", queryParameters);
            parameters.Total = queryParameters.Get<int>("Total");

            return result;
        }

        public async Task<IEnumerable<SparePartConsumption_Report_Response>> GetSparePartConsumption_Report(SparePartConsumption_Report_Search parameters)
        {
            DynamicParameters queryParameters = new DynamicParameters();
            ...
            var result = await ListByStoredProcedure<SparePartConsumption_Report_Response>("GetSparePartConsumption_Report", queryParameters);
            parameters.Total = queryParameters.Get<int>("Total");
